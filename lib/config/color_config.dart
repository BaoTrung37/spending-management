...
class FixedColors {
  ...
  static const fixedPlayerBackgroundDefault = Color(0xFF000000);
  static const fixedPlayerBackgroundTransparent = Color(0x80000000);
  static const fixedPlayerBackgroundTransparentContrast = Color(0x66D6D6D6);
  static const fixedPlayerSurfaceDefault = Color(0xFF1F1F25);
  static const fixedPlayerAction = Color(0xFF30323F);
  static const fixedPlayerSurfaceContrast = Color(0xFFD6D6D6);
  static const fixedPlayerBorder = Color(0xFFD6D6D6);
  static const fixedPlayerTextPrimary = Color(0xFFFFFFFF);
  static const fixedPlayerTextSecondary = Color(0xFF85859F);
  static const fixedPlayerTextContrast = Color(0xFF000000);
  static const fixedPlayerIconPrimary = Color(0xFFFFFFFF);
  static const fixedPlayerIconSecondary = Color(0xFF4C4C63);
  static const fixedPlayerBrandPrimary = Color(0xFF9428E8);
  static const fixedPlayerBrandGradientStart = Color(0xFFB100FF);
  static const fixedPlayerBrandGradientEnd = Color(0xFF35A8E9);
  static const fixedPlayerBrandSecondary = Color(0xFF076F91);
  static const fixedPlayerSemanticInfo = Color(0xFF2196F3);
  static const fixedPlayerPlayback = Color(0xFFFD3535);
}
...
class DarkColors {
  ...
  static const googleButton = Color(0xFF4285F4);
  static const yahooButton = Color(0xFFFF0033);
  static const splashBackground = Color(0xFF0E0E0E);
}
